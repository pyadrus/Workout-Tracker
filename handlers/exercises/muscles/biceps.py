...
async def curls_with_a_barbell_or_EZ_bar(callback_query: types.CallbackQuery) -> None:
    ...
    try:
        document = FSInputFile('messages/images/biceps/curls_with_a_barbell_or_EZ_bar.jpg')
...
async def bend_the_arms_on_the_lower_block(callback_query: types.CallbackQuery) -> None:
    ...
    try:
        document = FSInputFile('messages/images/biceps/bend_the_arms_on_the_lower_block.jpg')
...
async def dumbbell_curl(callback_query: types.CallbackQuery) -> None:
    ...
    try:
        document = FSInputFile('messages/images/biceps/dumbbell_curl.jpg')
...
async def reverse_grip_pull_ups(callback_query: types.CallbackQuery) -> None:
    ...
    try:
        document = FSInputFile('messages/images/biceps/reverse_grip_pull_ups.jpg')
...
async def bent_over_barbell_row_with_reverse_grip(callback_query: types.CallbackQuery) -> None:
    ...
    try:
        document = FSInputFile('messages/images/biceps/bent_over_barbell_row_with_reverse_grip.jpg')
...
async def hammer_grip_curl(callback_query: types.CallbackQuery) -> None:
    ...
    try:
        document = FSInputFile('messages/images/biceps/hammer_grip_curl.jpg')
...
async def incline_dumbbell_curl(callback_query: types.CallbackQuery) -> None:
    ...
    try:
        document = FSInputFile('messages/images/biceps/incline_dumbbell_curl.jpg')
...
async def concentrated_arm_curls(callback_query: types.CallbackQuery) -> None:
    ...
    try:
        document = FSInputFile('messages/images/biceps/concentrated_arm_curls.jpg')
...
async def scott_bench_curl(callback_query: types.CallbackQuery) -> None:
    ...
    try:
        document = FSInputFile('messages/images/biceps/scott_bench_curl.jpg')
...
async def arm_bending_with_elbow_abduction(callback_query: types.CallbackQuery) -> None:
    ...
    try:
        document = FSInputFile('messages/images/biceps/arm_bending_with_elbow_abduction.jpg')
